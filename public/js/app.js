...
لذلك، تعد الحفاظ على التراث مسؤولية نشطة. لا تنجو العربة أو القاطرة أو المحطة إلا عندما يقوم الناس بإصلاحها وتوثيقها ونقل مهاراتها.`
  ...
  // ==========================================================================
      ...
      "en": {
            ...
            "hero_tag_blue": "PRETORIA TO CAPE TOWN CORRIDOR · THE BLUE TRAIN",
            "hero_tag_rovos": "CAPITAL PARK TO CAPE TOWN CORRIDOR · ROVOS RAIL SAFARI",
            ...
            "hero_desc_blue": "A luxury rail ticket for this route can cost tens of thousands of Rand. TrackTales traces the same line—a 1,600 km 5-star spectrum running from the Highveld through Kimberley to the Atlantic ocean.",
            "hero_desc_rovos": "Step aboard \"The Most Luxurious Train in the World\". An extraordinary 3-day, 1,600 km vintage Edwardian journey spanning the golden Highveld, Kimberley diamond mines, the Great Karoo, and Matjiesfontein.",
            "hero_stat_route": "1,600 km",
            "hero_stat_duration_blue": "31 Hours Express",
            "hero_stat_duration_rovos": "3 Days / 48 Hours",
            "hero_stat_speed_blue": "90 km/h Air-Suspension",
            "hero_stat_speed_rovos": "60 km/h Restored Steam",
            "hero_stat_excursion_blue": "Kimberley Diamond Excursion",
            "hero_stat_excursion_rovos": "Kimberley & Matjiesfontein",
            "rail_runners_tag": "TRACKTALES · THE RAIL RUNNERS",
            ...
            "stops_filter_all": "All Corridor Stops",
            "stops_filter_scheduled": "Scheduled Excursions",
            "stops_filter_passthrough": "Passthrough Stations",
            ...
            "stories_heritage_tag": "HERITAGE ARCHIVE",
            "by_author": "By",
            ...
            "vault_unlocked_badge": "PREMIUM ARCHIVAL VAULT UNLOCKED",
            "vault_unlocked_title": "Deeper Historical <span class=\"text-[#B87C10] italic font-serif\">Archival Dossiers</span>",
            "vault_unlocked_sub": "Access declassified rail ledgers, wartime secret runs, and blueprint schematics for {train}.",
            "vault_declassified_files": "Declassified Files",
            "btn_inspect_dossier": "Inspect Dossier",
            ...
            "audio_active_badge": "AUDIO EXPERIENCE PASS ACTIVE",
            "audio_active_title": "Narrated Journey <span class=\"text-[#2A9D8F] italic font-serif\">Audio Companion</span>",
            "audio_active_sub": "Listen to live speech-synthesized narration of heritage stories, commentary, and ambient rail soundscapes.",
            "audio_status_ready": "READY",
            "audio_select_story_label": "SELECT JOURNEY STORY TO LISTEN:",
            "narrator_james_name": "Narrator James",
            "narrator_james_role": "Heritage Historian",
            "narrator_thandi_name": "Narrator Thandi",
            "narrator_thandi_role": "Karoo Explorer",
            "narrator_willem_name": "Narrator Willem",
            "narrator_willem_role": "Steam Master",
            "audio_btn_play": "PLAY STORY AUDIO",
            "audio_btn_stop": "STOP",
            "audio_speed_label": "Speed:",
            "soundscape_mixer_title": "AMBIENT SOUNDSCAPE MIXER",
            "soundscape_synth_label": "Web Audio Synthesizer",
            "soundscape_chug": "Karoo Track Chug & Steam",
            "soundscape_wind": "Great Karoo Desert Wind",
            "soundscape_lounge": "Luxury Salon Cello & Piano",
            ...
            "quiz_subtext": "Select the correct railway stop answer below to advance along the corridor.",
            "quiz_prev_stop": "Previous Stop",
            "quiz_next_stop": "Next Stop Quiz",
            ...
            "bingo_win_title": "BINGO WIN!",
            "bingo_win_desc": "Congratulations! You stamped 3 landmarks in a row along the Pretoria to Cape Town corridor.",
            "bingo_stamped_prefix": "Stamped",
            "bingo_stamped_suffix": "of 9 landmarks",
            "bingo_status_label": "Keep spotting landmarks along the train window!",
            ...
            "voice_badge": "REAL-TIME DICTATION & TRAVEL DIARY",
            "voice_title": "Passenger Voice <span class=\"text-[#D99B26] italic font-serif\">Journal</span>",
            "voice_subtitle": "Record your spoken travel observations, landmark thoughts, and corridor reflections in real time. Our speech engine transcribes your voice directly into your personal rail journey log.",
            "voice_landmark_label": "CORRIDOR LANDMARK / STOP",
            "voice_category_label": "JOURNAL CATEGORY",
            "voice_record_hint": "TAP MIC TO SPEAK",
            "voice_engine_tag": "Browser Speech-to-Text Recognition Active",
            "voice_transcript_label": "LIVE SPOKEN TRANSCRIPT",
            "voice_transcript_ph": "Speak into your microphone or tap the microphone button above to start transcribing your train story...",
            "btn_voice_clear": "Clear",
            "btn_voice_copy": "Copy",
            "btn_voice_read_back": "Read Back",
            "btn_voice_simulate": "Sample Dictation",
            "btn_voice_save": "SAVE TO JOURNAL",
            "voice_saved_title": "Saved Voice Notes",
            "voice_saved_sub": "TRANSCRIBED TRAVEL MEMORIES",
            "voice_search_ph": "Search voice notes...",
            "voice_filter_all": "ALL",
            "voice_filter_blue": "THE BLUE TRAIN",
            "voice_filter_rovos": "ROVOS RAIL",
            "voice_export_hint": "Save a permanent text copy",
            "btn_export_journal": "Export Diary (.txt)",
            "voice_privacy_notice": "Voice audio is transcribed locally in your browser session for complete privacy.",
            "voice_privacy_tag": "1,600 KM CORRIDOR COMPANION",
            ...
            "trains_selected_badge": "SELECTED TRAIN:",
            "trains_title_blue": "The <span class=\"text-[#B87C10] italic font-serif\">Blue Train</span>",
            "trains_title_rovos": "Rovos <span class=\"text-[#2A9D8F] italic font-serif\">Rail Safari</span>",
            "trains_subtitle_suffix": "Complete luxury suites, dining, and specifications for your selected train journey.",
            "trains_scenery_badge": "SCENIC SPLENDOUR & VANTAGE POINTS",
            "trains_scenery_title": "Corridor Landscapes & Sightseeing Highlights",
            "trains_scenery_sub": "Key scenic landmarks along the Pretoria to Cape Town rail corridor.",
            "trains_culinary_badge": "FINE DINING & SOCIALISING",
            "trains_dining_title": "Onboard Gastronomy & Salon Lounges",
            "trains_specs_badge": "TECHNICAL SPECIFICATIONS & HERITAGE",
            "trains_highlights_title": "Signature Experience Highlights",
            "label_speed": "Speed",
            "label_duration": "Duration",
            "label_corridor": "Corridor",
            "label_departure_hub": "Departure Station",
            "label_terminus_station": "Terminus Station",
            "label_vantage_tip": "Vantage Tip"
      },
      "zu": {
  ...
  function setupMultiLanguage() {
    ...
    function applyLanguage(code) {
      ...
      const heroStats = document.getElementById('hero-train-stats');
      ...
      if (heroTag) heroTag.textContent = isBlue ? (dict.hero_tag_blue || dict.hero_tag) : (dict.hero_tag_rovos || dict.hero_tag);
      if (heroDesc) heroDesc.textContent = isBlue ? (dict.hero_desc_blue || dict.hero_desc) : (dict.hero_desc_rovos || dict.hero_desc);
      if (heroStats) {
        const routeText = dict.hero_stat_route || '1,600 km';
        const durationText = isBlue ? (dict.hero_stat_duration_blue || '31 Hours Express') : (dict.hero_stat_duration_rovos || '3 Days / 48 Hours');
        const speedText = isBlue ? (dict.hero_stat_speed_blue || '90 km/h Air-Suspension') : (dict.hero_stat_speed_rovos || '60 km/h Restored Steam');
        const excursionText = isBlue ? (dict.hero_stat_excursion_blue || 'Kimberley Diamond Excursion') : (dict.hero_stat_excursion_rovos || 'Kimberley & Matjiesfontein');
        const accentColor = isBlue ? '#B87C10' : '#2A9D8F';
        heroStats.innerHTML = `
          <span class="flex items-center gap-2"><i data-lucide="route" class="w-3.5 h-3.5 text-[${accentColor}]"></i> ${routeText}</span>
          <span class="flex items-center gap-2"><i data-lucide="clock" class="w-3.5 h-3.5 text-[${accentColor}]"></i> ${durationText}</span>
          <span class="flex items-center gap-2"><i data-lucide="${isBlue ? 'zap' : 'flame'}" class="w-3.5 h-3.5 text-[${accentColor}]"></i> ${speedText}</span>
          <span class="flex items-center gap-2"><i data-lucide="${isBlue ? 'gem' : 'landmark'}" class="w-3.5 h-3.5 text-[${accentColor}]"></i> ${excursionText}</span>
        `;
      }
